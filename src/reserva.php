        ...
        <div class="nav-container">
            ...
            <div class="auth-buttons">
                ...
                <div style="position: relative; display: inline-block;">
                    ...
                    <span style="position:absolute;top:-8px;right:-8px;background:red;color:#fff;border-radius:50%;min-width:20px;height:20px;padding:0 5px;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:bold;z-index:1;">
                        <?php echo $cart['total_paquetes']; ?>
                    </span>
                </div>
